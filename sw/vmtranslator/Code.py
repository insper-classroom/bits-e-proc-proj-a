...
# implementando a parte que faz a tradução de um comando vm (pilha) em nasm (registrador-memória),
...
# TODO
    ...
    def writeArithmetic(self, command):
        ...
        if command == "add":
            ''' Implementando a operacoes aritméticas, mais especifica a de 
            add (que soma dois elementos na pilha). '''
           
            # A variável command é um vetor (na verdade ela vai virar um vetor de strings), é nesta variável que iremos adicionar as instruções assembly
            commands.append("leaw $SP, %A")
            commands.append("movw, (%A), %A")
            commands.append("decw %A")
            commands.append("movw (%A), %D")
    ...
    # WritePop é o método que escreve o comando pop no arquivo de saída em assembly
